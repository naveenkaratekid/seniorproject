...
public class SearchScreens extends Application
{
	...
	{ 
	   ...
	   yelpView.setOnMouseClicked(new EventHandler<MouseEvent>()
	   {
	    ...
	    updateProfileMenuButton.setTranslateX(425);
